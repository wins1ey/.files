...
static const char *dmenucmd[] = { "dmenu_run_history", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_blue, "-sf", col_gray4, NULL };
static const char *termcmd[]  = { "st", NULL };
static const char *lockcmd[]  = { "slock", NULL };
static const char *screenshotsavecmd[] = { "/bin/sh", "-c", "flameshot screen -n 0 -p $HOME/Pictures/screenshots", NULL };
static const char *screenshotclipcmd[] = { "flameshot", "screen", "-n", "0", "-c", NULL };
static const char *snipcmd[] = { "flameshot", "gui", NULL };
static const char *savereplaycmd[] = { "/bin/sh", "-c", "$HOME/.scripts/gpu-screen-recorder/save-replay.sh", NULL };
static const char *filemanagercmd[] = { "thunar", NULL };
static const char *prevsongcmd[] = { "playerctl", "-p", "spotify", "previous", NULL };
...
static const Key keys[] = {
    ...
    { MODKEY|ShiftMask,         XK_Print,   spawn,         {.v = screenshotsavecmd } },
    { 0,                        XK_Print,   spawn,         {.v = screenshotclipcmd } },
    { MODKEY|ShiftMask,         XK_v,       spawn,         {.v = savereplaycmd } },
